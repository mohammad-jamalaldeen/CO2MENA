...
<ul class="breadcrumb">
    ...
    <div class="customer-support">
      <form class="input-form" id="welltotankfuels-create" method="POST" action="{{ route('welltotankfuels.store') }}"  enctype="multipart/form-data" >
        @csrf
        <div class="row">
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="form-group">
                    ...
                    {{-- <input type="text" name="type" value="{{ old('type') }}" placeholder="Gaseous fuels" 
                    class="form-controal"> --}}
            ...
            <div class="col-md-4 col-sm-6 col-12">
                <div class="form-group">
                    ...
                    <input type="text" name="fuel" value="{{ old('fuel') }}" placeholder="Enter Fuel" 
                    class="form-controal">
                    @error('fuel')
                    <span class="error-mgs">{{ $message }}</span>
                    @enderror
