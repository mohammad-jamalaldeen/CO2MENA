        ...
        <table style="width: 100%;padding-bottom:15px;border-bottom:1px solid #D5E2DE;">
            <tr>
                <td style="text-align:left;vertical-align:middle;" colspan="0">
                    ...
                    <img src="{{ asset('assets/images/logo.png') }}" alt="logo-icon" width="167"
                        height="40" />
                </td>
                ...
                <table style="width: 100%; padding: 15px 0 0 0;">
                                ...
                                <tr>
                                    <td style="width:50%;text-align:left;vertical-align:top;">
                                        <table style="width: 100%;padding:0;">
                                            ...
                                            {{-- <tr>
                                                <td style="width:50%;font-family: sans-serif; font-weight: 700;color: #204C65; font-size: 12px;padding-bottom:15px;">Orgrnazation Name</td>
                                                <td style="width:50%;font-family: sans-serif; text-align: right; color: #32AE59; font-size: 14px; line-height: 16px; font-weight: 700;padding-bottom:15px;">{{ $companyData->company_name }}</td>
                                            </tr> --}}
                                            <tr>
                                    ...
                                    <td style="width:50%;text-align:right;vertical-align:top;">
                                        <table style="width: 100%;padding:0;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:65%;font-family: sans-serif;text-align: right; color: #32AE59; font-size: 14px; line-height: 16px; font-weight: 700;padding-bottom:15px;">Dashboard</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%; padding: 0;" cellspacing="15">
                                <tr>
                                    <td style="padding: 12px; border: 1px solid #D5E2DE; background-color: #F0F9F6; color: #204C65; border-radius: 24px;vertical-align:top;">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="font-family: sans-serif;font-weight: 700;color: #204C65; font-size: 12px; text-align:center;">
                                                    TOTAL EMISSIONS
                                                    {{-- <span style="padding-left:8px;font-family: sans-serif;font-weight: 400;color: #204C65; font-size: 12px;">Kg CO2-eq</span> --}}
                                                </td>                                            
                                            </tr>
                                            <tr>
                                                <td style="font-family: sans-serif;color: #32AE59; font-size: 16px; line-height: 18px; font-weight: 700;text-align:center;">{{ $totalEmissions }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td style="padding: 12px; border: 1px solid #D5E2DE; background-color: #F0F9F6; color: #204C65; border-radius: 24px;vertical-align:top;">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="font-family: sans-serif; font-weight: 700;color: #204C65; font-size: 12px;text-align:center;">
                                                    TOTAL ENERGY USED
                                                    {{-- <span style="padding-left:8px;font-family: sans-serif;font-weight: 400;color: #204C65; font-size: 12px;">Kwh</span> --}}
                                                </td>
                                            </tr>
                                            <tr>
                                                <td style="font-family: sans-serif;color: #32AE59; font-size: 16px; line-height: 18px; font-weight: 700;text-align:center;">{{ $totalenergyused }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table style="width: 100%; padding: 0;" cellspacing="15">
                                ...
                                @endif
                                        <td style="width: 50%; padding: 16px; border: 1px solid #D5E2DE; border-radius: 24px; vertical-align: top;">
                                            <table style="width: 100%; padding: 0;">
                                                <tr>
                                                    <td style="color: #204C65; font-size: 12px; line-height: 24px;height: 24px; padding-bottom: 20px; font-weight: 700; text-transform: uppercase;">{{$key == "myDoughnutChart" ? "Overview": str_replace('_', ' ', $key)}}</td>
                                                </tr>
                                                <tr>
