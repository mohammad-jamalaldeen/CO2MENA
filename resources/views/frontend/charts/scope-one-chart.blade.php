        ...
        <table style="width: 100%;padding-bottom:15px;border-bottom:1px solid #D5E2DE;">
            <tr>
                <td style="text-align:left;vertical-align:middle;" colspan="0">
                    <img src="{{ asset('assets/images/logo.png') }}" alt="logo" width="167" max-width="100px"
                        height="40" />
                </td>
                ...
                <table style="width: 100%; padding: 15px 0 0 0;">
                                    ...
                                    <td style="width:50%;text-align:right;">
                                        <table style="width: 100%;padding:0;">
                                            ...
                                            <tr>
                                                ...
                                                <td style="width:65%;font-family: sans-serif;text-align: right; color: #32AE59; font-size: 14px; line-height: 16px; font-weight: 700;padding-bottom:15px;">Scope -1</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                    ...
                    <tr>
                        <td>
                            <table style="width: 100%; padding: 0;" cellspacing="15">
                                <tr>
                                    <td style="padding: 12px; border: 1px solid #D5E2DE; background-color: #F0F9F6; color: #204C65; border-radius: 24px;width:50%;">
                                        <table style="width: 100%;">
                                            ...
                                            <tr>
                                                <td style="font-family: sans-serif;text-align: right; color: #32AE59; font-size: 16px; line-height: 30px; font-weight: 700; text-align:center;">{{ $totalEmissions }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                    <td style="padding: 12px; border: 1px solid #D5E2DE; background-color: #F0F9F6; color: #204C65; border-radius: 24px; text-align:center;width:50%;">
                                        <table style="width: 100%;">
                                            <tr>
                                                <td style="font-family: sans-serif; font-weight: 700; color: #204C65; font-size: 12px; text-align:center;">ALL TYPE OF FUEL USED</td>
                                            </tr>
                                            <tr>
                                                <td style="font-family: sans-serif;text-align: right; color: #32AE59; font-size: 16px; line-height: 30px; font-weight: 700; text-align:center;">{{ $totalFuel }}</td>
                                            </tr>
                                        </table>
                                    </td>
                                </tr>
                            ...
                            <table style="width: 100%; padding: 0;" cellspacing="15">
                                ...
                                @endif
                                        <td style="width: 50%; padding: 16px; border: 1px solid #D5E2DE; border-radius: 24px; vertical-align: top;">
                                            <table style="width: 100%; padding: 0;">
                                                <tr>
                                                    <td style="color: #204C65; font-size: 12px; line-height: 24px;height: 24px; padding-bottom: 20px; font-weight: 600; text-transform: uppercase;">{{$key == "myDoughnutChart" ? "Overview": str_replace('_', ' ', $key)  }}</td>
                                                </tr>
                                                <tr>
