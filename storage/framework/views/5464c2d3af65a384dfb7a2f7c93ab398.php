...
<?php $__env->startSection('content'); ?>
    <?php if(!frontendPermissionCheck('frontend-datasheets.create')): ?>
        <?php
    ...
    <div class="table-header <?php echo e($classlist); ?>">
        <div class="row align-items-center" <?php echo e($display); ?>>
            <div class="col-12">
                <div class="dw-header">
                    <a class="download-btn" <?php echo e($sampleDataSheetURL != '#!' ? 'download' : ''); ?>

                        href="<?php echo e($sampleDataSheetURL); ?>">
                        <picture>
                            <img src="<?php echo e(asset('assets/images/document-download-icon.svg')); ?>" alt="document-download-icon"
                                width="" height="">
                        </picture>
                        DOWNLOAD SHEET
                    </a>
                    ...
                    <ul class="new-table-filter">
                        ...
                        <li>
                            <select class="form-control action-select" name="last_action_by" title="Last Action"
                                ...
                                <?php for($i = 0; $i < count($filterLastAction); $i++): ?>
                                 <option title="<?php echo e($filterLastAction[$i]['last_action_by']); ?>"
                                        value="<?php echo e($filterLastAction[$i]['last_action_by']); ?>">
                                        <?php echo e($filterLastAction[$i]['last_action_by']); ?></option>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="content-inner">
                    ...
                    <form id="datasheet-add-form" action="<?php echo e(route('frontend-datasheets.store')); ?>"
                            ...
                            <div class="col-md-4 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <input type="text" class="form-controal" name="uploaded_by" id="uploaded_by"
                                        value="<?php echo e(Auth::guard('web')->user()->name); ?>" readonly
                                    ...
                                    <div class="input-group date-group errorDateTimeCls">
                                        ...
                                        <div class="input-group-append">
                                            <span class="input-group-text" id="basic-addon2">
                                                <picture>
                                                    <img src="<?php echo e(asset('assets/images/calendar-icon.svg')); ?>"
            ...
            <div class="modal-content">
                ...
                <div class="content-inner">
                    ...
                    <div class="progress-report">
                        <picture>
                            <img src="<?php echo e(asset('assets/images/prgress-bar.svg')); ?>" alt="prgress-bar" width=""
                                height="">
                        </picture>
                        ...
                        <div class="col-12">
                            <div class="btn-wrap">
                                <a class="btn-primary" href="">
                                    CONTINUE
                                    <picture>
                                        <img src="<?php echo e(asset('assets/images/button-arrow.svg')); ?>" alt="button-arrow"
                                            width="24" height="24">
                                    </picture>
                                </a>
                            </div>
        ...
        <div class="modal-dialog modal-dialog-centered">
            <div class="modal-content">
                ...
                <div class="content-inner">
                    ...
                    <form id="datasheet-edit-form" method="POST" action="<?php echo e(route('frontend-datasheets.update')); ?>"
                        class="input-form">
                        <?php echo csrf_field(); ?>
                            ...
                            <div class="col-md-2 col-sm-6 col-12">
                                <div class="form-group">
                                    ...
                                    <div class="file-icon" id="editUploadedSheet">
                                        <picture>
                                            <img src="<?php echo e(asset('assets/images/file-icon.png')); ?>" alt="file-icon"
                                                width="34" height="41">
                                        </picture>
                                    </div>
                                </div>
    ...
    <?php echo $__env->make('common-modal/ds-publish-modal', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?>
    <style>
        #out:focus #ccc {
            display: none;
        }
    ...
    <script type="text/javascript">
        $(document).ready(function() {
            ...
            var table = $("#manage-customer").DataTable({
                ...
                ajax: {
                    url: "<?php echo e(route('frontend-datasheets.ajax')); ?>",
                    dataType: "json",
                    data: function(d) {
                        if(d.draw != '1')
                        {
                ...
                "drawCallback": function(settings) {
                    ...
                    $("#manage-customer_previous").html(
                        '<img src="<?php echo e(asset('assets/images/back-arrow.svg')); ?>" alt="back-icon">');
                    $("#manage-customer_next").html(
                        '<img src="<?php echo e(asset('assets/images/arrow-next.svg')); ?>" alt="next-icon">');
            ...
            $(".publish-btn").click(function() {
                var id = $(this).attr('data-id');
                var current_object = "<?php echo e(url('front/datasheet/publish-datasheet/')); ?>" + '/' + id;
                window.location.href = current_object;
            });
            ...
            $('#view-datasheet-modal').on('show.bs.modal', function(e) {
                ...
                let id = btn.data('id');
                let userUrl = "<?php echo e(url('/front/datasheet/show')); ?>/" + id;
                $.ajax({
                    url: userUrl,
                    type: 'GET',
                        ...
                        if (result.status == 'true') {
                            ...
                            if (result.data['uploadedSheetUrl'] != "-") {
                                uploadSheetUrlHtml =
                                    ...
                                    result.data[
                                        'uploadedSheetUrl'] +
                                    '"><span class="file-icon"><picture><img src="<?php echo e(asset('assets/images/file-icon.png')); ?>" alt="file-icon" width="34" height="41"></picture></span></a>';
                            } else {
                                uploadSheetUrlHtml = '-';
                            }
            ...
            $('#edit-datasheet-modal').on('show.bs.modal', function(e) {
                ...
                let id = btn.data('id');
                let userUrl = "<?php echo e(url('/front/datasheet/edit')); ?>/" + id;
                $.ajax({
                    url: userUrl,
                    type: 'GET',
                    success: function(result) {
        ...
        function updateStatus() {
            ...
            $.ajax({
                url: "<?php echo e(route('frontend-datasheets.update-status')); ?>",
                type: 'get',
                processData: false,
                contentType: false,
                success: function(response) {
...
<?php echo $__env->make('frontend.layouts.main', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\M7md Jamal\Projects\0-milestones\1-CO2MENA\CO2MENA - SaaS Based Web Application\Source Code\co2mena\Source-Code\resources\views/frontend/datasheets/index.blade.php ENDPATH**/ ?>