...
<?php $__env->startSection('content'); ?>
    ...
    <div class="export-line export-backend">
        ...
        <form action="<?php echo e(route('dashboard.print-chart')); ?>" method="post" enctype="multipart/form-data" id="graph-form">
            <?php echo csrf_field(); ?>
            ...
            <button type="submit" title="export" class="export-button <?php echo e(adminPermissionCheck('dashboard.print-chart') === false ? 'd-none' : 'd-block'); ?>">
                <picture>
                    <img src="<?php echo e(asset('assets/images/export-icon.svg')); ?>" alt="export-icon" title="export-icon" width="" height="">
                </picture>EXPORT</a>
            </button>
    ...
    <div id="dashboard">
        <section class="membercount-section">
            <ul>
                <li>
                    <a href="<?php echo e(route('datasheet.index')); ?>" class="totle-text">Activity Sheets</a>
                    <div class="totle-number" id="totalDatasheets">
                        <?php echo e(isset($totalDatasheetsCount) ? $totalDatasheetsCount : '0'); ?></div>
                </li>
                <li>
                    <a href="<?php echo e(route('sub-admin.index')); ?>" class="totle-text">TOTAL SUB ADMIN MEMBERS</a>
                    <div class="totle-number" id="totalSubAdminMembers">
                        <?php echo e(isset($totalSubAdminCount) ? $totalSubAdminCount : '0'); ?></div>
                </li>
                <li>
                    <a href="<?php echo e(route('customer.index')); ?>" class="totle-text">TOTAL CUSTOMER MEMBERS</a>
                    <div class="totle-number" id="totalCustomereMembers">
                        <?php echo e(isset($totalCustomerCount) ? $totalCustomerCount : '0'); ?></div>
                </li>
            </ul>
        </section>
    ...
    <div id="loader">
        <div class="loader-inner">
            <img src="<?php echo e(asset('assets/loader.gif')); ?>" alt="loader" title="loader"/>
        </div>
    </div>
<?php $__env->stopSection(); ?>

<?php $__env->startSection('footer_scripts'); ?>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/chart.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/chartjs-plugin-datalabels.min.js')); ?>"></script>
    <script type="text/javascript" src="<?php echo e(asset('assets/js/html2canvas.min.js')); ?>"></script>
    <script type="text/javascript">
        document.addEventListener("DOMContentLoaded", function() {
            let labels = ['Completed', 'In Progress', 'Uploded', 'Published', 'Failed', 'Draft'];
            let dataValues = [
                        <?php echo e($doughnutData->completedCount); ?>,
                        <?php echo e($doughnutData->inProgressCount); ?>,
                        <?php echo e($doughnutData->uploadedCount); ?>,
                        <?php echo e($doughnutData->publishedCount); ?>,
                        <?php echo e($doughnutData->failedCount); ?>,
                        <?php echo e($doughnutData->draftCount); ?>
    ...
    <script type="text/javascript">
        document.addEventListener('DOMContentLoaded', function() {
            ...
            var dataChartSubAdmin = <?php echo json_encode($dataChartSubAdmin); ?>;
            var labels_subadmin = <?php echo json_encode($labels_subadmin); ?>;
            ...
            var myBarChart;
            var dataChartCustomer = <?php echo json_encode($dataChartCustomer); ?>;
            var labels_customer = <?php echo json_encode($labels_customer); ?>;
...
<?php echo $__env->make('admin.layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH D:\M7md Jamal\Projects\0-milestones\1-CO2MENA\CO2MENA - SaaS Based Web Application\Source Code\co2mena\Source-Code\resources\views/admin/dashboard.blade.php ENDPATH**/ ?>